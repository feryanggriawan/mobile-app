...
import 'package:tsi_mobile/widgets/terapis/pasien_data.dart';

class TerapisPasienItemExpanded extends StatefulWidget {
  final Pasien pasien;

  const TerapisPasienItemExpanded({Key key, this.pasien}) : super(key: key);

  @override
  _TerapisPasienItemExpandedState createState() =>
      _TerapisPasienItemExpandedState();
}

class _TerapisPasienItemExpandedState extends State<TerapisPasienItemExpanded> {
  bool expanded = false;
