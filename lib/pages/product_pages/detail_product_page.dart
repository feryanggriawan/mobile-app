...
class _DetailProductPageState extends State<DetailProductPage> {
  ...
  void initState() {
    ...
    if (product.variant.isNotEmpty) selectedVariant = product.variant.first;
    super.initState();
  }
          ...
          child: CustomScrollView(
            slivers: [
              SliverPersistentHeader(
                delegate: MySliverAppBar(expandedHeight: 370, product: product),
                pinned: true,
              ),
              buildSliverListBody()
            ],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    currencyFormatExtension(selectedVariant != null
    ...
    return SliverList(
      delegate: SliverChildListDelegate(
        [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text.rich(TextSpan(children: <TextSpan>[
                          TextSpan(
                              text:
                                  "${currencyFormatExtension(product.basePrice)}",
                              style: ralewayTextStyle.copyWith(
                                  color: textDark3,
                                  fontSize: 12.sp,
          ...
          if (product.grosirPrice.isNotEmpty)
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...List.generate(
                    jsonDecode(product.grosirPrice).length,
                    (index) => jsonDecode(product.grosirPrice)[index]
                                ["price"] !=
                            null
                        ? Text(
                            "${jsonDecode(product.grosirPrice)[index]["min_qty"]} harga ${jsonDecode(product.grosirPrice)[index]["price"]}",
                            style: ralewayTextStyle.copyWith(
...
class MySliverAppBar extends SliverPersistentHeaderDelegate {
  ...
  MySliverAppBar({@required this.expandedHeight, this.product});
    ...
    return Stack(
      ...
      children: [
        FadeInImage(
          ...
          image: NetworkImage(product.images[0].file),
          fit: BoxFit.cover,
        ),
        Stack(
          children: [
